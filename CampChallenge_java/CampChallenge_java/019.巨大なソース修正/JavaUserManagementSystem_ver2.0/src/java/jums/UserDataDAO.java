...
public class UserDataDAO {
    ...
    public ArrayList<UserDataDTO> search(UserDataDTO ud) throws SQLException{
        ...
        try{
            ...
            int position = 0;
            int positionbirthday = 0;
            int positiontype = 0;
            boolean nameflag = false;
            boolean birthdayflag = false;
            boolean typeflag = false;
            //部分検索機能 positionが0なら先頭、各flagで入力されているか確認
            ...
            if(nameflag == true)st.setString(1, "%"+ud.getName()+"%");
            if(birthdayflag == true)st.setString(positionbirthday, "%"+ new SimpleDateFormat("yyyy").format(ud.getBirthday())+"%");
            if(typeflag == true)st.setInt(positiontype, ud.getType());
            
            ResultSet rs = st.executeQuery();
            //nullチェックにおいてpreviousで妥協
            if(rs.first()){
