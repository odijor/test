...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(!data.getName().equals("") || !data.getYear().equals("") || !data.getMonth().equals("") ||
      ...
      out.write("<br>\n");
      out.write("        生年月日:");
      out.print( data.getYear()+"年"+data.getMonth()+"月"+data.getDay()+"日");
      out.write("<br>\n");
      out.write("        種別:");
      out.print( data.getType());
      out.write("<br>\n");
      out.write("        電話番号:");
      out.print( data.getTell());
      out.write("<br>\n");
      out.write("        自己紹介:");
      out.print( data.getComment());
      out.write("<br>\n");
      ...
      out.write("\n");
      out.write("    <h1>入力が不完全です<br>\n");
      out.write("        下記の入力をお願いします<br>\n");
      out.write("        ");
